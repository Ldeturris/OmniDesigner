...
java -Duser.timezone=UTC -Xmx1000m -cp %CLASSPATH% com.ataccama.dqc.bootstrap.DqcBootstrap "%DQ_HOME%" com.ataccama.dqc.server.bin.OnlineCtl -config=../services/_match_services.serverConfig start
