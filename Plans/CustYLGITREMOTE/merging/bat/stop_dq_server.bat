...
java -Duser.timezone=UTC -cp %CLASSPATH% com.ataccama.dqc.bootstrap.DqcBootstrap "%DQ_HOME%" com.ataccama.dqc.server.bin.OnlineCtl -config=../services/_merge_services.serverConfig stop
